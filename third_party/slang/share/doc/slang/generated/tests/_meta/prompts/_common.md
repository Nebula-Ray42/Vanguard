...
evidence:
  command: <exact slangc/slang-tests invocation that triggers the failure>
...
expected:
  ...
  citation_kind: spec | sibling-tests | older-slangc | doc
...
provenance:
  ...
  doc_anchor: <docs/generated/design/<file>.md#<section> the tests was anchored to>
```
